<!-- BEGIN: Top Bar -->
<div class="relative z-[50] flex h-[67px] items-center border-b border-slate-200">
    @section('breadcrumbs')
    <!-- BEGIN: Breadcrumb -->
    ...
    <x-base.menu>
        ...
        @else
            <x-base.menu.button class="intro-x block h-8 w-8 overflow-hidden rounded-full shadow-lg">
