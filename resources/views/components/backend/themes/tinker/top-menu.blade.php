<div @class([
    ...
    <x-backend.mobile-menu />
    <!-- BEGIN: Top Bar -->
    <div
        class="relative z-[50] -mx-5 mb-10 mt-12 h-[70px] border-b border-white/[0.08] px-4 sm:-mx-8 sm:px-8 md:mx-0 md:mb-8 md:mt-0 md:px-6">
        <div class="flex h-full items-center">
            ...
            >
                ...
                />
                <span class="ml-3 text-lg text-white"> {{ auth()->user()->company()->first()->name ?? 'Vacation Manager' }} </span>
            </a>
            <!-- END: Logo -->
            @section('breadcrumbs')
                <!-- BEGIN: Breadcrumb -->
