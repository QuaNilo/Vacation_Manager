            ...
            <x-base.slideover.description class="p-0">
                <div class="flex flex-col">
                    <div class="px-8 pb-8 pt-6">
                        <div class="text-base font-medium">{{ __('Themes') }}</div>
                        <div class="mt-0.5 text-slate-500">{{ __('Choose your theme') }}</div>
                                    ...
                                    >
                                        <div class="image-fit h-full w-full overflow-hidden rounded-md">
                                            <img
                                                ...
                                                src="{{ asset('images/themes/' . $theme . '.png') }}"
                                                alt="{{ config('app.name') }}"
                                            >
                                        </div>
                                    </a>
                    ...
                    <div class="px-8 pb-8 pt-6">
                        <div class="text-base font-medium">{{ __('Layouts') }}</div>
                        <div class="mt-0.5 text-slate-500">{{ __('Choose your layout') }}</div>
                                ...
                                <div>
                                    ...
                                    >
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img
                                                class="h-full w-full"
                                                src="{{ asset('images/layouts/' . $layout . '.png') }}"
                                                alt="{{ config('app.name') }}"
                                            >
                                        </div>
                                    </a>
                    ...
                    <div class="border-b border-dashed"></div>
                    <div class="px-8 pb-8 pt-6">
                        <div class="text-base font-medium">{{ __('Accent Colors') }}</div>
                        <div class="mt-0.5 text-slate-500">
                            {{ __('Choose your accent color') }}
                        </div>
                    ...
                    <div class="border-b border-dashed"></div>
                    <div class="px-8 pb-8 pt-6">
                        <div class="text-base font-medium">{{ __('Appearance') }}</div>
                        <div class="mt-0.5 text-slate-500">
