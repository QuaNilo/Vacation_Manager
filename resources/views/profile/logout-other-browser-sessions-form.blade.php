<x-jetstream.action-section>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-jetstream.button wire:click="confirmLogout" wire:loading.attr="disabled" type="button">
        ...
        <x-jetstream.dialog-modal wire:model.live="confirmingLogout">
            ...
            <x-slot name="footer">
                <x-jetstream.secondary-button wire:click="$toggle('confirmingLogout')" wire:loading.attr="disabled" type="button">
                    {{ __('Cancel') }}
