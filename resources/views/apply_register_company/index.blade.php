<x-backend-base-layout>
    <div id="main-div" class="flex justify-center items-center h-screen align-middle bg-gradient-to-r from-blue-300 to-blue-800">
        <div id="cards-div" class="flex space-x-10 h-1/2">
            <a href="{{route('companies.create')}}">
                <div id="register-company-card" class="flex flex-col bg-primary/70 p-6 text-white shadow-2xl transform hover:scale-105 transition duration-300 ease-in-out">
                    ...
                    <p class="text-center mt-4">{{__('Informação sobre o cartão')}}</p>
                </div>
            </a>
            <a href="{{route('companies.join')}}">
                <div id="apply-company-card" class="flex flex-col bg-primary/70 p-6 text-white shadow-2xl transform hover:scale-105 transition duration-300 ease-in-out">
