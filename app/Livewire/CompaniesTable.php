...
class CompaniesTable extends Component implements HasForms, HasTable
{
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            TextColumn::make("telephone")
                ->label($newModel->getAttributeLabel("telephone"))
                ->sortable()
                ->toggleable()
                ->searchable(),
            ...
            ->actions([
                Action::make('edit')
                ->label(__('Update'))
                ->url(fn (Company $record): string => route('companies.edit', ['company' => $record]))
            ...
            ->defaultSort('id', 'desc')
            ->recordUrl(
                fn (Model $record): string => route('companies.show', ['company' => $record]),
            )
            //->striped()
