...
class VacationsTable extends Component implements HasForms, HasTable
{
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            TextColumn::make("vacation_days")
                ->label($newModel->getAttributeLabel("vacation_days"))
                ->sortable()
                ->toggleable()
                ->searchable(),
            ...
            ->actions([
                Action::make('edit')
                ->label(__('Update'))
                ->url(fn (Vacation $record): string => route('vacations.edit', ['vacation' => $record]))
            ...
            ->defaultSort('id', 'desc')
            ->recordUrl(
                fn (Model $record): string => route('vacations.show', ['vacation' => $record]),
            )
            //->striped()
